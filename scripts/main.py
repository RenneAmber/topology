...
'''
python main.py --train 1 --net lenet32 -- dataset mnist -- trial 55 -- n_epochs_train 40 --lr 0.0001 -- permute_label 0.0 --binarize_labels -1 --data_subset 1.0 --epochs_test 2 --thresholds '0.2 0.05 0.9' --split 0 --kl 0 --graph_type structural --n_samples 5
'''
...
if args.graph_type=='functional':
    ...
    os.system('python ../build_graph_structural.py --save_path '+SAVE_PATH+' --net '+args.net+' --dataset '+args.dataset+' --trial '+args.trial+' --epochs '+args.epochs_test+' --thresholds '+thresholds+' --permute_labels '+args.permute_labels+' --binarize_labels '+args.binarize_labels)
...
if args.graph_type=='functional_per_sample' or args.graph_type=='structural':
